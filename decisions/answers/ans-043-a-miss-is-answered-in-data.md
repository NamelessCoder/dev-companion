...
of them, so what this cost is three fields and three lines beside the count.
Each is present where it was computed and absent where the text withholds it.
...
number is what says where it was taken.
