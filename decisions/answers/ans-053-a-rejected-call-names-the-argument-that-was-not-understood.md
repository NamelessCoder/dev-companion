...
Both candidates were measured against this checkout over stdio and the first was
taken: the unqualified call is answered with the two branches, neither of which
the caller was asking about, and with the property declaration the same call
names the property it refuses. So the assumption holds. It is declared on this
tool and on no other.
