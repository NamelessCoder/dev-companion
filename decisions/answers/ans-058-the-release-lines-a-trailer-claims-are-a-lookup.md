...
established the maintained lines from a remote listing and a directory listing
nineteen days after this lookup was written, and reported that the server
offered no way to check them. It reached the right lines and said itself that
the inference fails on a shallow clone or a stale remote.
