...
# D-ANS-074 — A path-narrowed suite list names the domains it withheld and when to ask again
...
- Queued rather than closed on the spot. The block is built in
  ...
  contract, which [judging.md](../../documentation/feedback/judging.md) puts on
