...
- The covered lines are named in the quickstart, and
  `VersionsTest::theReadmeNamesEveryCoveredLine` holds them to
...
- `SiteTest::theSiteOpensOnTheReadmeAndNotOnTheMap`
- `SiteTest::aLinkOnTheFrontPageDropsTheDirectoryTheSiteServesAtItsRoot`
- `SiteTest::aPageBelowTheFrontOneReachesItAsTheIndex`
- `VersionsTest::theReadmeNamesEveryCoveredLine`
