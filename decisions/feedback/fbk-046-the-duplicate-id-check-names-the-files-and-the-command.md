...
Confirmed by a day of five sessions at once: four collisions over about fifteen
cards, each repaired from the assertion's own message without the page being
opened, which is what the entry set out to buy. Raising the count did not raise
the share.

What the message does not cover is the second half of the repair. The renumber
rewrites every path naming the entry's file and moves none of the prose that
names the id — deliberate and stated, but at this rate the common case: every
one of the four needed an edit by hand afterwards.
