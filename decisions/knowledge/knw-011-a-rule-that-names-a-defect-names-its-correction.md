...
- The rule is delivered and the correction is not. `typo3_hint_lookup`, run
  against this branch with the task "TYPO3 extension conformance audit: the
...
- The audit-shaped query is what fails.
  ...
  `typo3_hint_lookup` without naming a language file, would move the answer to
  step 2.
