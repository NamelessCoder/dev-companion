...
- Domains::JAVASCRIPT is deleted rather than kept for a hint that might want it.
  A domain nothing detects as is a tag that can only mislead the next author.
