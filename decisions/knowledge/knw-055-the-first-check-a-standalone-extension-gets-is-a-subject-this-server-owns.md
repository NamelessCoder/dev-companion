...
The corpus reading was done out of an installed `typo3/coding-standards`, since
the package is in no checkout here. What does not hold is the trap it drew,
which is what made it rewrite the finder: the excluded names are matched at any
