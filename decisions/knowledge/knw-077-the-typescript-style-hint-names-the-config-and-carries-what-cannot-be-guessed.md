...
# D-KNW-077 — The TypeScript style hint names the config and carries what cannot be guessed
...
- Taken on, as sentences in `backend-typescript` rather than as a rule corpus.
  ...
  [`D-KNW-064`](knw-064-the-disabled-assertions-a-core-checkout-carries-are-a-grep-and-not-a-lookup.md)'s
