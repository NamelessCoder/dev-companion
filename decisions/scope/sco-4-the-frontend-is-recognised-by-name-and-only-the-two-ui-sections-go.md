...
- **Corrected on `2026-08-02`:** the withholding held and the sentence about the
  escape did not. That contributor was asked, with a
  ...
  corpus back settles the loss the entry was worried about: `css-class-naming`
  is `.toolbar-item`, `.module-docheader` and `t3js-*`,
...
- **Since then:** both halves are held rather than argued.
