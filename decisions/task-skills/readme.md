...
A skill lands in someone else's project and runs there without this repository
around it. These are the decisions about what it carries with it and in which
order it works.
...
[D-SKL-086]: skl-086-the-stale-notice-reaches-the-answer-that-names-the-skill.md
...
[D-SKL-082]: skl-082-a-declared-change-type-on-core-paths-names-the-patch-workflow.md
...
[D-SKL-070]: skl-070-a-description-is-held-to-a-length-of-its-own.md
...
[D-SKL-065]: skl-065-a-defect-reported-by-its-symptom-is-routed-to-the-cause.md
...
[D-SKL-046]: skl-046-a-precondition-is-restated-where-the-file-it-guards-is-written.md
[D-SKL-047]: skl-047-the-composer-root-step-fetches-the-installer-keys.md
[D-SKL-048]: skl-048-a-build-workflow-says-a-symptom-is-a-lookup-trigger.md
[D-SKL-049]: skl-049-the-gate-at-the-end-of-a-workflow-waits-for-its-corrections.md
[D-SKL-050]: skl-050-producing-a-distributions-content-earns-a-task-skill.md
...
[D-SKL-056]: skl-056-the-installation-workflow-branches-on-the-declared-procedure.md
[D-SKL-057]: skl-057-a-commands-options-are-read-from-the-installed-console.md
[D-SKL-058]: skl-058-a-hint-is-routed-by-what-the-repository-is.md
[D-SKL-059]: skl-059-an-installation-that-answers-is-owned-by-its-workflow.md
...
[D-SKL-063]: skl-063-reviewing-a-change-against-a-package-earns-a-task-skill.md
...
[D-SKL-009]: skl-009-a-rule-that-keeps-not-landing-is-written-as-an-act.md
