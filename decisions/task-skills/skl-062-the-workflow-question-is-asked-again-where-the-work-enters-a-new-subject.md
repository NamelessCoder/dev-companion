...
- **The session.** `/home/benji/projects/blog` on 2026-08-18,
  `claude-opus-5[1m]`,
  [`feedback/2026-08-18-081159`](../../feedback/2026-08-18-081159-skills-are-matched-once-against-the-opening.md).
...
- **The description route is closed.** The twelve published descriptions cost
  ...
  `SkillTest::everyDescriptionIsWrittenToTheBudgetTheyShare` allows, measured
