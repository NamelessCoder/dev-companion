...
Finally, if the deprecation sweep is genuinely owed for a change of this kind (new test file plus a fixture edit, no Classes/ touched), say so in the development skill's entry; if it is not, the exemption would be worth stating there, because a reviewer who crosses over is going to reach for that judgement anyway.
