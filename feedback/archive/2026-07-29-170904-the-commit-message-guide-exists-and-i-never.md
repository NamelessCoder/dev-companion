...
The larger share of this is mine — the routing table is there and I did not re-read it. But a checklist item that describes writing the commit message, in a tool built to hand out next steps, is the natural place for the pointer.
