...
Trimmed on 2026-08-27. What it reports as working is read as evidence about the
boundary `D-ANS-069` drew — the enumeration answering per row and the journal
staying behind one read per issue — and is written into that entry under the
date. What is left is the suggestion below.
