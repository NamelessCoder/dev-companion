...
# R-AUD-4 — The knowledge is bound to versions
...
catalog entry carries the same binding for the whole entry, because markup and
a class list are pasted together, and a target version withholds it rather than
