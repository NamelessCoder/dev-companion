...
**The seeding answer names impexp as what a site or page tree is built from
again, and a seeding script as what is written for content that exists nowhere
yet.**

The export is the artifact a distribution ships and re-imports, not the residue
of a one-off run.
