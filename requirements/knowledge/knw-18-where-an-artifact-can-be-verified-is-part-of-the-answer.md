...
# R-KNW-18 — Where an artifact can be verified is part of the answer

**Where an artifact cannot be verified where it is produced, the answer says
where it can be.**

A mechanism that runs once leaves its author reading their own output back and
