...
**A non-English site setup reaches the complete label-language chain: the site
language selects the pack key explicitly, the pack is activated through the
configuration key of the target branch before it is updated, and literal
