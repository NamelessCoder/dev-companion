...
the declaration the answer shows. Unknown is a third answer and not a quiet no:
a test suite runs the project's own code, and nothing in a manifest covers what
...
repositories (2026-07-31) that were told not to change files and ran none of the
