...
# R-PRJ-6 — What an extension does not ship is answered too

**An extension answer says what the extension ships beside its registrations
— its manual, its README, the test layers it has, and its XLF files with the
source language each declares — and says it when the artifact is not there.**
