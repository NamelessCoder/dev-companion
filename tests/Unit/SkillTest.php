...
final class SkillTest extends TestCase
{
    ...
    public function theAuthoringContractIsWrittenDownAndNamesWhatHoldsIt(): void
    {
        ...
        $page = (string) file_get_contents(Paths::root() . '/documentation/contributing/writing-a-skill.md');
     ...
     * ones [documentation/contributing/writing-a-skill.md](../../documentation/contributing/writing-a-skill.md)
