...
D-DIS-004's second **Wrong if** — a caller working on a version other than the
...
this gets wrong is the one D-DIS-004 singles out as withheld rather than qualified:
...
point is one withheld string is a different decision than the one D-DIS-004 took.
