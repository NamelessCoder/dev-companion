...
`REVIEW-02` run 5 is the session `D-ANS-003` asked to be recorded: it left the v13
...
which is how a registry with no console command is already asked (`D-DIS-005`).
